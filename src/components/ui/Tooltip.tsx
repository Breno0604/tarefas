...
export default function Tooltip({ content, children, side = 'top' }: { content: string; children: React.ReactNode; side?: 'top' | 'bottom' | 'left' | 'right' }): React.JSX.Element | React.ReactNode {
  const positions = {
